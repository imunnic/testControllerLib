...
public enum TrialPatriotRace implements Trial {
  ...
  DEVIL_PRESS("Devil press",
      "Completa tantos devil press como sea posible en un tiempo determinado") {
  ...
  TrialPatriotRace(String name, String description) {
    this.name = name;
